...
namespace PDF_Llama
{
    public partial class Mallinen
    {
        public const string RetrainFilePath =  @"C:\Users\risto\OneDrive\Documents\JKM_Price.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:9,seriesLength:28,trainSize:137,horizon:10,outputColumnName:@"Price",inputColumnName:@"Price",confidenceLowerBoundColumn:@"Price_LB",confidenceUpperBoundColumn:@"Price_UB");
