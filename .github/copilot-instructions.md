# PDF Llama .NET SDK Copilot Instructions
...
### Overview
Uses a custom JSON discriminator pattern for polymorphic serialization of types and error codes instead of the default `NotSupportedException` from System.Text.Json.
